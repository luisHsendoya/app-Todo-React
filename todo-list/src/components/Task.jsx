...
function Task({date,message,setTask,id,deleteTask}) {
  ...
  return (
    <div className='relative rounded-2xl shadow-xl bg-slate-300 my-1 py-5 max-w-sm mx-auto mb-5  md:w-72 md:h-fit' >
        ...
        <div className='flex flex-col justify-center'>
            <p className={`mx-2 my-5 text-lg font-mono tracking-widest uppercase leading-relaxed text-clip indent-2 ${check && 'line-through'}`}>{message}</p>
            <button onClick={handlerEdit} className='relative text-rose-900 top-2 mx-auto w-20 bg-yellow-300 rounded-full  hover:bg-yellow-500 hover:-translate-y-1'>Edit</button>
        </div>
